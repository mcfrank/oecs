...
A critical breakthrough for cognitive science was the advent of causal Bayes nets (Pearl, 2000), which formalize the concept of a causal model and provide a computational framework for causal and counterfactual inference [see [Causal Learning](/articles/i1om74mo)]. It distinguishes inferences based on observation (“I see the lights are on and infer that someone is home”) from inferences based on interventions (“I switch the lights on but do not infer that someone else is home”) and defines counterfactuals in terms of interventions on causal models (see Figure 1). It also links causal models with probabilities and shows how Bayesian updating depends on causal structure.

![](images/articles/ee7y4opg/figure_1.png)

**Figure 1.** Using a causal model for counterfactual inference.
