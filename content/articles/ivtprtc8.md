...
slug: ivtprtc8
date: '2025-09-02'
doi: 10.21428/e2759450.6609ecb6
authors:
- Giosuè Baggio
section_editors:
- Asifa Majid
...
In cognitive science, meaning has been viewed as the “holy grail” of the study of mind (Jackendoff, 2002), essential to understanding symbolic cognition and communication. Some authors consider meaning as *grounded* in concepts [see [Concepts](https://doi.org/10.21428/e2759450.1145a437)], perception, action, and other systems of the mind and brain (Barsalou, 2008). While controversial as a general theory of meaning, this approach has proved useful for analyzing certain linguistic phenomena. The metaphor “time is a thief” does not convey that time belongs to the set of thieves. It rather suggests that time shares certain characteristics with a thief, such as stealth and the removal of something valuable (e.g., youth or opportunity). This kind of meaning, which relies on relations between concepts rather than set membership (Lakoff & Johnson, 1980), is difficult to represent in standard model-theoretic semantics.
...
Montague, R. (1970), English as a formal language. In B. Visentini (Ed.), *Linguaggi nella Società e nella Tecnica* (pp. 189**–**224). Edizioni di Comunità.

Portner, P. H., & Partee, B. H. (Eds.). (2008). *Formal semantics: The essential readings*. Wiley.

Jackendoff, R. (2002). *Foundations of language*. Oxford University Press. <https://doi.org/10.1093/acprof:oso/9780198270126.001.0001>
...
Janssen, T. M., & Partee, B. H. (1997). Compositionality. In J. F. van Benthem & A. Ter Meulen (Eds.), *Handbook of logic and language* (pp. 417**–**473). Elsevier. <https://doi.org/10.1016/B978-044481714-3/50011-4>
...
Schlenker, P. (2022). *What it all means. Semantics for (almost) everything*. MIT Press. <https://doi.org/10.7551/mitpress/12128.001.0001>

Millikan, R. (1984). *Language, thought, and other biological categories*. MIT Press. <https://doi.org/10.7551/mitpress/4124.001.0001>
