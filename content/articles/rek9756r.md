...
In fact, some languages only have small numbers. For example, in the Hup dialect of the Nadahup language spoken in the Brazilian Amazon, the word for one is “unity,” the word for two is “eye quantity,” and the word for three is “rubber tree seed quantity” (Epps, 2006). However, words for larger exact quantities do not exist. Other Nadahup dialects add to this a body counting system and accompany gestures with expressions like “both hands” to represent 10 and “both hands and both feet” to represent 20 (see ).
