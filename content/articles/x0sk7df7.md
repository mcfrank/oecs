...
slug: x0sk7df7
date: '2025-03-31'
doi: 10.21428/e2759450.b3e7ef9b
authors:
- Manolo Martínez
section_editors:
...
- Kriegeskorte, N., & Diedrichsen, J. (2019). Peeling the onion of brain representations. *Annual Review of Neuroscience*, *42*, 407–432. [https://doi.org/10.1146/annurev-neuro-080317-061906](https://doi.org/10.1146/annurev-neuro-080317-061906)
...
Aristotle. (1987). *De anima (On the soul)* (H. Lawson-Tancred, Trans.). Penguin Classics. (Original work published 350 BCE.)

Brentano, F. (1973). *Psychology from an empirical standpoint* (A. C. Rancurello & D. B. Terrell, Trans., L. L. McAlister, Ed. & Trans.). Routledge & Kegan Paul. (Original work published 1874)

Stampe, D. W. (1977). Toward a causal theory of linguistic representation. *Midwest Studies in Philosophy*, *2*(1), 42–63. <https://doi.org/10.1111/j.1475-4975.1977.tb00027.x>

Millikan, R. G. (1984). *Language, thought, and other biological categories*. MIT Press.

Frege, G. (1970). Begriffsschrift, a formula language, modeled upon that of arithmetic, for pure thought. In J. Van Heijenoort (Ed.), *Frege and Gödel* (pp. 1–82). Harvard University Press. (Original work published in 1879.)
...
Marr, D. (2010). *Vision: A computational investigation into the human representation and processing of visual information*. MIT Press. (Original work published in 1982.)

Piccinini, G. (2020). *Neurocognitive mechanisms: Explaining biological cognition*. Oxford University Press.

Cummins, R. (1989). *Meaning and mental representation*. Bradford Books.

Machery, E. (2009). *Doing without concepts*. Oxford University Press.

Evans, G. (1982). *The varieties of reference* (J. McDowell, Ed.). Oxford University Press.

Toribio, J. (2007). Nonconceptual content. *Philosophy Compass*, 2(3), 445–460. <https://doi.org/10.1111/j.1747-9991.2007.00075.x>
...
Vorms, M. (2011). Formats of representation in scientific theorizing. In P. W. Humphreys & C. Imbert (Eds.), *Models, simulations, and representations* (pp. 250–273). Routledge.

Coelho Mollo, D., & Vernazzani, A. (2024). The formats of cognitive representation: A computational account. *Philosophy of Science*, *91*(3), 682-701. <https://doi.org/10.1017/psa.2023.123>
...
Poldrack, R. A. (2020). The physics of representation. *Synthese*, *199*, 1307–1325. <https://doi.org/10.1007/s11229-020-02793-y>
...
Artiga, M. (2023) [Forthcoming]. Understanding structural representations. *The British Journal for the Philosophy of Science.* <https://doi.org/10.1086/728714>

Schulte, P. (2018). Perceiving the world outside: How to solve the distality problem for informational teleosemantics. *The Philosophical Quarterly*, *68*(271), 349–369. <https://doi.org/10.1093/pq/pqx052>

Shea, N. (2018). *Representation in cognitive science*. Oxford University Press.

Artiga, M. (2016). Liberal representationalism: A deflationist defense. *Dialectica*, 70(3), 407–430. <https://doi.org/10.1111/1746-8361.12152>

Rescorla, M. (2013). Millikan on honeybee navigation and communication. In D. Ryder, J. Kingsbury, & K. Williford (Eds.), *Millikan and her critics* (pp. 87–102). Wiley-Blackwell.

Ryder, D. (2019). Problems of representation II: Naturalizing content. In S. Robbins, J. Symons, & P. Calvo (Eds.), *The Routledge companion to philosophy of psychology* (pp. 251-279*)*. Routledge.

Fodor, J. A. (1990). *A theory of content and other essays*. MIT Press.

Egan, F. (2025). *Deflating mental representation*. The MIT Press.

Skyrms, B. (2010). *Signals: Evolution, learning, and information*. Oxford University Press.

Shannon, C. E., & Weaver, W. (1998). *The mathematical theory of communication*. University of Illinois Press. ((Original work published 1949.)

Cao, R. (2012). A teleosemantic approach to information in the brain. *Biology & Philosophy*, *27*, 49–71. <https://doi.org/10.1007/s10539-011-9292-0>
...
Figdor, C. (2020). Shannon + Friston = Content: Intentionality in predictive signaling systems. *Synthese*, *199*, 2793-2816. <https://doi.org/10.1007/s11229-020-02912-9>
...
Kriegeskorte, N., & Douglas, P. M. (2019). Interpreting encoding and decoding models. *Current Opinion in Neurobiology*, *55*, 167–179. <https://doi.org/10.1016/j.conb.2019.04.002>

Richards, B. A., Lillicrap, T. P., Beaudoin, P., Bengio, W., Bogacz, R., Christensen, A., Clopath, C., Ponte Costa, R., de Berker, A., Ganguli, S., Gillon, C. J., Hafner, D., Kepecs, A., Kriegeskorte, N., Latham, P., Lindsay, G. W., Miller, K. D., Naud, R., Pack, C. C., … Kording, K. P. (2019). A deep learning framework for neuroscience. *Nature Neuroscience*, *22*, 1761–1770. <https://doi.org/10.1038/s41593-019-0520-2>
...
Subotić, V. (2024). Exploring, expounding & ersatzing: A three-level account of deep learning models in cognitive neuroscience. *Synthese*, *203*, 94. <https://doi.org/10.1007/s11229-024-04514-1>

Tye, M. (2000). *Consciousness, color and content*. MIT Press.

Mendelovici, A. A. (2018). *The phenomenal basis of intentionality*. Oxford University Press.