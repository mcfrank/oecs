...
It has been known for decades that spoken language is organized into prosodic constituents (Chomsky & Halle, 1968; Ladd, 1996; Lehiste, 1970; Nespor & Vogel, 1986). For example, if a person were to say *Whenever I drink wine I get a headache*, the word *wine* would be elongated and somewhat emphasized, the fundamental frequency of that word would fall and then quickly rise, and a pause might follow. As a result, the listener would perceive the utterance as two intonational phrases separated by a prosodic boundary. Below the intonational phrase are other prosodic constituents including prosodic phrases, prosodic words, and syllables. In some theories of prosody, this hierarchy of constituents is governed by principles such as the strict layering hypothesis (Selkirk, 1984), which posit that prosodic constituents must nest neatly without overlap, so that each constituent is fully housed within higher-level structures. This constraint contrasts with what we see in syntax, where a clause, for example, may be inserted inside a smaller constituent such as a noun phrase.
...
Prosody sits at the intersection of language and cognition. It guides how people produce and interpret spoken language in real time, shaping everything from syntactic parsing to discourse interpretation, and reflecting cognitive processes such as planning, memory, and attention. It also plays a key role in development, helping infants segment speech and bootstrap syntax. Beyond language, prosody signals emotion, speaker intent, and social position, linking linguistic structure to broader systems of perception and communication. In short, studying prosody gives cognitive scientists a window into how the mind handles the complexities of language in context and in interaction.

# Further reading

- Cole, J. (2015). Prosody in context: A review. *Language, Cognition and Neuroscience*, *30*(1-2), 1-31.
- Larrouy-Maestri, P., Poeppel, D., & Pell, M. D. (2025). The Sound of Emotional Prosody: Nearly 3 Decades of Research and Future Directions. *Perspectives on Psychological Science*, *20*(4), 623–638
...
Biron, T., Baum, D., Freche, D., Matalon, N., Ehrmann, N., Weinreb, E., Moses, E., & Biron, D. (2021). Automatic detection of prosodic boundaries in spontaneous speech. *PLOS ONE, 16*(5), Article e0250969.
...
De Carvalho, A., Kolberg, L. S., Trueswell, J., & Christophe, A. (2022, May). Cross-linguistic evidence for the role of phrasal prosody in syntactic and lexical acquisition. In *Speech Prosody 2022* (pp. 396-400).

Degano, G., Donhauser, P. W., Gwilliams, L., Merlo, P., & Golestani, N. (2024). Speech prosody enhances the neural processing of syntax. *Communications Biology, 7*, Article 748.
...
Gervain, J., Christophe, A., & Mazuka, R. (2021). Prosodic Bootstrapping. In Gussenhoven, C. and Chen, A. (Ed.) *The Oxford Handbook of Language Prosody* (pp. 563–573*).* Oxford, England: Oxford University Press

Han, M., De Jong, M., De Jong, N.H., & Kager, R. (2024). Relating the prosody of infant-directed speech to children’s vocabulary size. *Journal of Child Language*, 51(1):217-233.

Hirose, Y. (2003). Recycling prosodic boundaries. *Journal of Psycholinguistic Research, 32*, 167–195.

Inbar, M., Grossman, E., & Landau, A. N. (2025). A universal of speech timing: Intonation units form low-frequency rhythms. *Proceedings of the National Academy of Sciences*, *122*(34), e2425166122. [https://doi.org/10.1073/pnas.2425166122](https://doi.org/10.1073/pnas.2425166122)

Inbar, M., Grossman, E., & Landau, A. N. (2020). Sequences of intonation units form a ~1 Hz rhythm*.* *Scientific Reports, 10*, Article 15846.

Jusczyk, P. W., Hirsh-Pasek, K., Nelson, D. G., Kennedy, L., & Woodward, A. (1992). Perception of acoustic correlates of major phrasal units by young infants. *Cognitive Psychology, 24*(2), 252–293.

Kallay, J. E., Mayr, U., & Redford, M. A. (2019). Characterizing the coordination of speech production and breathing. *Proceedings of the 19th International Congress of Phonetic Sciences (ICPhS 2019)*, 1412–1416.

Ladd, D. R. (1996). *Intonational phonology*. Cambridge University Press.

Lehiste, I. (1970). *Suprasegmentals*. Cambridge, MA: MIT Press.

Lamekina, Y., & Meyer, L. (2023). Entrainment to speech prosody influences subsequent sentence comprehension. *Language, Cognition and Neuroscience*, *38*(3), 263-276.
...
Sandler, W. (2010). Prosody and syntax in Sign Languages. *Transactions of the Philological Society. Philological Society, 108(3), *298-328.
...
Snedeker, J., & Trueswell, J. C. (2003). Using prosody to avoid ambiguity: Effects of speaker awareness and referential context. *Journal of Memory and Language, 48*(1), 103–130.
...
Vetchinnikova, S., Konina, A., Williams, N., Mikusová, N., & Mauranen, A. (2023). Chunking up speech in real-time: Linguistic predictors and cognitive constraints. *Language and Cognition, 15*(3), 453–479.

Wilbur, R.B. (2022). Prosody in sign languages. *Hrvatska revija za rehabilitacijska istrazivanja*, *58* (Special Issue), 143-174.