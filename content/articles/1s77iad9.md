...
![](images/articles/1s77iad9/figure_3.png)

**Figure 3.** Shadows and reflections. (A) The shadow of the key is quite convincing, although there is no key. *(*B) When the shadow of Thor’s hammer on the man’s pants is not correctly linked to the hammer, it loses its shadow character and is interpreted as a stain.
